 ...
 * When thread is interrupted declines new tasks.
 * Finishes working when all tasks are complete.
 * @author Daria
 */
		...
		while (true){			
			try {
				...
				try {
					...
					log.log(Level.WARNING, "Exception caught when closing connection", e1);
				}
				return;
			}
		}	
